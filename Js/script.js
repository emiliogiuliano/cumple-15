...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para mi Persona Favorita:\n\nDesde el primer momento q te vi, tu sonrisa, tu voz, tu forma de ser… todo en ti me hace sentir como la persona mas suertuda del mundo, solo con verte.\n\nTe amo más de lo que las palabras pueden expresar, mas de lo que en todo este tiempo q te eh hablado pude demostrar.\n\nY si algun dia piensas q mi querer a de fallecer, yo te lo desmintire con un florecer.Por todolo que hiciste y sos GRACIAS`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Emi❤️";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-07-03T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-06-29T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Pasaron <b>${days}</b> dias desde que me enamoraste<br>` +
      `Tu cumpleaños es en: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
